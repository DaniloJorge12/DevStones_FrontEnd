...
const textos = {
    pt: {
        ...
        salvosDesc: 'Os quizzes que a IA criou ficam aqui para você refazer quando quiser.',
        salvosQuestoes: (n) => `${n} questões`,
        salvosRefazer: 'Refazer',
        salvosVazio: 'Nenhum quiz salvo ainda. Gere um acima!',
        geradoPorIA: 'GERADO POR IA',
    },
    en: {
        ...
        salvosDesc: 'The quizzes the AI created stay here for you to redo whenever you want.',
        salvosQuestoes: (n) => `${n} questions`,
        salvosRefazer: 'Redo',
        salvosVazio: 'No saved quizzes yet. Generate one above!',
        geradoPorIA: 'GENERATED BY AI',
    },
};
